#this script is used to download/cache the 7B Qwen model before running its generation job on Stanage.
...
MODEL_TO_DOWNLOAD = "Qwen/Qwen2.5-7B-Instruct"  #the 7B model that will be downloaded and stored in the Hugging Face cache
